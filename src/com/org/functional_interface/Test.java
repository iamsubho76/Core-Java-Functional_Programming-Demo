...
public abstract class Test {
	public static void main(String[] args) {
		...
		pack.stream().map(name -> name.toUpperCase()).forEach(System.out::println);
		...
		//Reducing Operation
		//reduce will always return you one rsult
		...
		Optional<String> longestName = pack.stream().reduce((name1, name2)->name1.length()>=name2.length() ? 
						name1 : name2);
	...
	public static void pickName(final List<String> listOfName, String startingLetter){
		...
		System.out.println("The first name that begins with : " + startingLetter + " : "
				+ foundName.orElse(" no name was found."));
